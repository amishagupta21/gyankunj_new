    ...
    <div className={styles.modal}>
      <div className="delete-modal-popus">
        <div className={styles.innerModal}>
          <a href="/" className="close-del-icon">
            <svg
              onClick={props.cancelIconHandler}
          ...
          <p className="info-content">
            Your account will be deleted permanently you will not be able to
            access the data.
          </p>
