...
import { SaveAssignmentData, publishAssignmentData } from "../../../ApiClient";
      ...
      >
        ...
        <Modal.Body>
          ...
          >
            ...
            <Col md={2}>
              <Button
                ...
                onClick={saveAssignmentModule}
                disabled={assignmentDataForStudent?.length == 0}
              >
                Save Assignment
              </Button>
            </Col>
            <Col md={2}>
              <Button
                variant="outline-primary"
                style={{
                  backgroundColor: enablePublish ? "green" : "",
                  color: enablePublish ? "white" : "",
                }}
                onClick={publishAssignmentModule}
          ...
          <Row style={{ marginTop: "30px" }}>
            <Col md={3}></Col>
            <Col md={6}>
              {assignmentDataForStudent.length > 0
                ? assignmentDataForStudent?.map((questionData, indx) => {
                      ...
                      >
                        <Card.Body>
                          <Row>
                            <Col md={10}>
                              <h6>
                                Q{indx + 1}. {questionData?.question}
                              </h6>
                            </Col>
                          ...
                          </Row>
                          {
                            <div>
                              <fieldset>
                                ...
                                {questionData?.all_options?.length > 0 && (
                                  <Row className="assignmentData">
                                    <Col md={2} style={{ textAlign: "left" }}>
                                      Options:
                                    </Col>
