          ...
          <Row>
            ...
            <Col
              ...
              style={{
                ...
                boxShadow: "rgba(180, 179, 179, 0.16) 0px 7px 6px",
                borderRadius: "5px",
              }}
            >
              {props?.absenteesValue?.map((absentee, indx) => {
                return `${indx + 1}. ${absentee}, `;
              })}
            </Col>
          </Row>
          <Row style={{ marginTop: "30px" }}>
            <Col md={3}>Dress Defaulter :</Col>
            <Col
              md={9}
              style={{
                height: "fit-content",
            ...
            >
              {props?.dressDValue?.map((dressD, indx) => {
                return `${indx + 1}. ${dressD}, `;
              })}
            </Col>
          </Row>
        </Modal.Body>
        <Modal.Footer>
          <Button variant="outline-primary" onClick={takeAttendance}>
            Verified
          </Button>
        </Modal.Footer>
      </Modal>
